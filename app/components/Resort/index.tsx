import khoang from "@/public/static/images/khoang-nong-lanh.png";
  ...
  return (
    <div className="w-full h-full min-h-screen">
      <section
        ...
        className="w-full h-full h-[300px] bg-[url('/static/images/leaft_right.png')] bg-right-bottom bg-no-repeat"
      >
        <div className="max-w-[1140px] mx-auto flex items-end h-full">
          <div className="flex flex-col w-full">
            <h2>
              <span
                className={clsx(
                  arsenal.className,
                  "text-[#396198] text-6xl font-semibold uppercase"
                )}
              >
                Mỗi căn nhà
              </span>
              <span
                className={clsx(pinyon.className, "text-[#346F7B] text-6xl")}
              >
                {" "}
                là một Resort trị liệu
              </span>
            </h2>
            <span
              className={clsx(
                arsenal.className,
                "text-[#396198] text-6xl font-semibold uppercase text-end"
              )}
            >
              Của riêng bạn
            </span>
      ...
      >
        <div className="max-w-[1140px] mx-auto flex">
          ...
          <div className="w-1/2 px-4">
            <Image alt="leaf" src={khoang} className="rounded-xl" />
          </div>
        </div>
      </section>
    </div>
