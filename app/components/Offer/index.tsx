...
export const Offer = () => {
  return (
    <div className="w-full px-12 py-14 bg-[#FF7A56] shadow-xl  tracking-wider">
      <div className="flex gap-2">
        <div className="flex w-1/4">
          <div className="flex flex-col justify-center gap-2">
            <span>Kiến tạo vùng xanh trường thọ bắt đầu từ sự cân bằng !</span>
          ...
          <ul className="list-none  tracking-wider">
            ...
            <li className="flex gap-2 py-3">
              ...
              <span className="font-semibold">
                Thanh toán chỉ 35% đến khi nhận nhà
              </span>
            </li>
            <li className="flex gap-2 py-3">
              <svg
